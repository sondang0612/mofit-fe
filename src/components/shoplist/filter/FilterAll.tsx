...
export default function FilterAll(props: Props) {
  ...
  const activeCategory = filter?.activeCategory
    ? Number(filter?.activeCategory)
    : null;
  const activeBrands = filter?.brands
  ...
  return (
    <div className="">
      <div className="accordion" id="categories-list">
        <div>
          <h5 className="tw-text-[18px]  text-uppercase tw-text-sm">
            Bộ lọc được áp dụng
          </h5>
